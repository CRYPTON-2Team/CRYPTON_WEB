...
import Leaved from "src/assets/auth/signUp/Icons/StatusLeaved.svg";
...
export const SignUp2StatusWrapper = styled.div`
  width: 75%;
  height: 23%;
  display: flex;
  justify-content: space-between;
...
export const LeavedStatusBox = styled.div`
  width: 31px;
  height: 30px;
  background-image: url(${Leaved});
  background-repeat: no-repeat;
`;
